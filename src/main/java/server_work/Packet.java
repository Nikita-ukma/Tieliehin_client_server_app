...
public class Packet {
    ...
    private Packet(long bPktId, Message bMsg) {
        this.bMagic = MAGIC_BYTE;
        this.bSrc = 1;
        this.bPktId = freeId++;
        this.bMsg = bMsg.toBytes();
    ...
    private Packet(long bPktId, byte[] bMsg) {
        this.bMagic = MAGIC_BYTE;
        this.bSrc = 1;
        this.bPktId = bPktId;
        this.bMsg = bMsg;
    ...
    public static Packet fromBytes(byte[] bytes) {
        ...
        Packet packet = new Packet(bPktId, bMsg);
    ...
    public static void printPacketDetails(Packet packet) {
        System.out.println("server_work.Packet Details:");
        ...
        System.out.println("server_work.Message: " + packet.getbMsg().getMessage());
