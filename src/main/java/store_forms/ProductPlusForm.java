...
public class ProductPlusForm extends JFrame {

    private JPanel backPanel;
    private JComboBox<Product> productField;
    private JTextField amountField;

    public ProductPlusForm(DefaultTableModel model, JFrame frame) throws SQLException {
        super("Add Product to Stock");
    ...
    private void init(DefaultTableModel model, JFrame frame) {
        ...
        JLabel captionLabel = new JLabel("Add Product to Stock");
        captionLabel.setHorizontalAlignment(JLabel.CENTER);
        captionLabel.setFont(new Font("Lucida Calligraphy", Font.PLAIN, 16));
    ...
    private void addProductToStock(DefaultTableModel model, JFrame frame) {
