...
public class Message {
    ...
    public static void printMessageDetails(Message message) {
        System.out.println("Decrypted models.Message Details:");
        System.out.println("commands.Command Type: " + message.getcType());
        System.out.println("User ID: " + message.getbUserId());
        System.out.println("models.Message: " + message.getMessage());
        System.out.println();
    }
    public int getcType() {
        return cType;
